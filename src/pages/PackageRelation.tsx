                        ...
                        <div className="card border-warning mb-3">
                            <div className="card-body p-3">
                                <div className='d-flex'>
                                    <span>Cliente: <b>{order.order_partner_id && order.order_partner_id[1]}</b></span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="card mb-3" key={line.id}>
                                <div className="card-body row">
                                    ...
                                    <div className="d-flex justify-content-between align-items-center mt-3">
                                        <span>Cliente: <b>{line.partner_id[1]}</b></span>
                                    </div>
                                    <span>Factura: <b>{line.nro_fv}</b></span>
                                    {line.nro_fv_adicional && <span>Adicional: <b className="badge bg-warning">{line.nro_fv_adicional}</b></span>}
                                    <span>Origen: <b>{order.shipping_origin_id[1]}</b></span>
                                    <span>Destino: <b>{line.shipping_destination_id[1]}</b></span>
